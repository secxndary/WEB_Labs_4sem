...
class Catalog extends Component {
  ...
  array = [
    ...
    { id: "Moon", name: "'Moon'", price: 340, inStock: 0, img: "/imgs/moon.jpg", desc: "Caterpillar MK50 custom. Inspired by Neil Armstrong's moonboots. Perfect for your trip to the Moon.", new: false, discount: 5, weight: 12, added: 0 },
    ...
    { id: "Off-road", name: "'Off-road'", price: 200, inStock: 2, img: "/imgs/off-road.jpg", desc: "New Balance 530 custom. Added additional bicycle mounts.", new: false, discount: 10, weight: 8, added: 10 },
  ];
  sort(byWhat) {
